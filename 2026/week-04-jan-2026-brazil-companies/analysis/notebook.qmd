...
p <- ggplot(plot_data) +
  ...
  labs(
    ...
    subtitle = "Almost 75% of Brazilian businesses operate as limited liability companies,\nwith micro and small enterprises making up the bulk of the market",
  ...
  theme(
    ...
    plot.subtitle = element_text(
      ...
      size = 14,
      lineheight = 0.8,
      margin = margin(b = 0, l = 20)
    ),
    plot.margin = margin(10, 48, 12, 8),
    legend.position = "none",
    plot.caption = element_text(
      color = "#747474ff",
      hjust = 0.1,
      size = 9,
      margin = margin(t = 0, l = 4)
    )
  ) +
  coord_cartesian(clip = "off")

ggsave("output/plot.png", p, width = 2000, height = 1600, units = "px")
```
